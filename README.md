...
- FRED macro time-series datasets (`macro_timeseries_long.parquet`, `macro_timeseries_wide.parquet`)
...
- `src/macro_pipeline.py`: FRED macro series download + parquet persistence (long + wide).
